...
JAPANESE_CHARS = f'{HIRAGANA}{KATAKANA}{HALF_SIZE_KATAKANA}{LEVEL_1_KANJI}'
...
# BAD_WORD_LIST_2 is adopted from
# https://github.com/thisandagain/washyourmouthoutwithsoap/blob/develop/data/build.json#L3260
BAD_WORD_LIST_2 = [
    "中絶",
    "アナル",
    "肛門",
